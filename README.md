...
[![release](https://img.shields.io/github/v/release/nikitaeight24family/Conch?color=brightgreen&label=release)](https://github.com/nikitaeight24family/Conch/releases/latest)
[![play store](https://img.shields.io/badge/Play%20Store-live-blue.svg)](https://play.google.com/store/apps/details?id=ai.eight24family.conch)
[![license](https://img.shields.io/badge/license-PolyForm%20Noncommercial-blue.svg)](LICENSE)

> **Your phone, your server, your AI. Build, test, ship — on the train.**

Conch is a mobile-first, AI-native IDE. The phone is the tactile interface;
your own VPS is where code, builds and tests run; an AI agent
...
- **Room** (sessions, servers, keys; encrypted via SQLCipher-equivalent
  layer on top of `androidx.security`)
- **EncryptedSharedPreferences** for keystore-backed secret-at-rest
...
No hosted backend. SSH only. **No analytics, no crash reporting, no
telemetry** — removed entirely in 0.4.1. The app opens no network connection
to anything except the servers you add — with one carve-out for local models:
model downloads from Hugging Face, and read-only catalog/pull-count fetches
(GitHub raw + HF public API) when the model store screen is open. Anonymous
GETs; nothing about the user or device is sent.

Full policy: <https://conch-labs.com/privacy.html>
...
- **v1.0.9**, Play Store launch in flight (closed test).
...
- **Commercial use** (selling forks, embedding in a paid product, putting
  it on a paid Play Store listing under your own brand) needs a separate
  commercial license. Open an issue or contact the maintainer.

Developer setup (build, tests, architecture notes) lives in
[CLAUDE.md](CLAUDE.md).
